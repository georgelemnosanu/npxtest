      ...
      items: [
        {
          ...
          description: "Sarmale tradiționale în foi de varză cu mămăligă și smântână",
          price: 32,
          image: "https://images.unsplash.com/photo-1673847852428-7069f3640238?w=800&auto=format&fit=crop&q=60",
          ingredients: ["carne tocată", "orez", "varză", "mălai", "smântână"],
        },
        {
          id: 4,
          name: "Cocoș la ceaun",
